...
<style>
  ...
  .mwt-h5bar {
    background:<?php if(isset($_G['bigstyle_config']['head_bgcolor'])) { ?><?php echo $_G['bigstyle_config']['head_bgcolor'];?><?php } else { ?>#ffb61e<?php } ?>;
  }
  .headbar td {
    background:<?php if(isset($_G['bigstyle_config']['head_bgcolor'])) { ?><?php echo $_G['bigstyle_config']['head_bgcolor'];?><?php } else { ?>#ffb61e<?php } ?>;
...
width:120px;
  ...
  .spacebg {background:<?php if(isset($_G['bigstyle_config']['head_bgcolor'])) { ?><?php echo $_G['bigstyle_config']['head_bgcolor'];?><?php } else { ?>#ffb61e<?php } ?>;color:#fff;}

  .footnav td {background:#fff;font-size:14px;}
  .foota {color:#999;text-decoration:none;}
  .foota.active {color:<?php if(isset($_G['bigstyle_config']['foot_color'])) { ?><?php echo $_G['bigstyle_config']['foot_color'];?><?php } else { ?>#ffb61e<?php } ?>;}
