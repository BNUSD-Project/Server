...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1541433506, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/bigstyle', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1541433506, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/bigstyle', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1541433506, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/bigstyle', 'common/header_home_spacecp')
;?>
