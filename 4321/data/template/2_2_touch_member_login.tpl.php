...
0
|| checktplrefresh('./template/bigstyle/touch/member/login.htm', './template/default/touch/common/seccheck.htm', 1541912087, '2', './data/template/2_2_touch_member_login.tpl.php', './template/bigstyle', 'touch/member/login')
